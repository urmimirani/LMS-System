...
<head>
    ...
    <style>
        ...
        * {
        ...
        .upload-materials-form select, .upload-materials-form input[type="file"] {
            width: 100%;
            padding: 10px;
            margin-top: 5px;
            margin-bottom: 15px;
        ...
        .upload-materials-form input[type="submit"] {
            background-color: #1e3799;
            color: #fff;
            border: none;
            cursor: pointer;
        ...
        .upload-materials-form input[type="submit"]:hover {
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="CourseListServlet?target=upload_materials" class="active">Upload Course Materials</a>
    ...
    <div class="main-content">
        ...
        <!-- Title -->
        <h2 class="dashboard-title">Upload Course Materials</h2>

        <!-- Upload Materials Form -->
        <div class="upload-materials-form">

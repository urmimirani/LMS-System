...
<head>
    ...
    <style>
        ...
        * {
        ...
        .quiz-data-form input[type="text"] {
            width: 100%;
            padding: 10px;
            margin-top: 5px;
            margin-bottom: 15px;
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="quiz-data-form">
            <form action="SaveQuizDataServlet" method="post">
                ...
                <% for (int i = 1; i <= numQuestions; i++) { %>
                    <div class="question-section">
                        ...
                        <input type="number" name="question_no_<%= i %>" required>

                        <label>Question Text:</label>
                        <input type="text" name="question_text_<%= i %>" maxlength="500" required>

                        <label>Option 1:</label>
                        <input type="text" name="option1_<%= i %>" maxlength="150" required>

                        <label>Option 2:</label>
                        <input type="text" name="option2_<%= i %>" maxlength="150" required>

                        <label>Option 3:</label>
                        <input type="text" name="option3_<%= i %>" maxlength="150" required>

                        <label>Option 4:</label>
                        <input type="text" name="option4_<%= i %>" maxlength="150" required>

                        <label>Correct Answer (1-4):</label>
                        <input type="number" name="correct_<%= i %>" min="1" max="4" required><br><br>
                    </div>
                <% } %>

                <input type="submit" value="Save Quiz Data">
            </form>
        </div>
    </div>
